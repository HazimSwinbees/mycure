...
import { getDoctorMedicalRecordById } from '../../services/medicalRecordApi'
...
const loadRecord = async () => {
  ...
  try {
    record.value = await getDoctorMedicalRecordById(route.params.id)
  } catch (error) {
    loadError.value = error.message || 'Unable to load the visit record.'
  } finally {
